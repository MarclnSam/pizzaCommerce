...
const sortingOptionsSelected = sortingOptions.value;
...
const sortingOrderingList = () => {
    ...
    console.log(listOfProductOrderingElementArray);
    const sortedListOfProductOrderingElementArray = bubbleSort(listOfProductOrderingElementArray);
  ...
  if (sortingOptionsSelected === 'Domyślnie') {
    return;
  }
};
